...
export const Timer: FunctionComponent<TimerProps> = ({ msLeft, timeFraction, isRunning }) => {
  ...
  return (
    <div className='cursor-pointer flex p-[16px] w-[300px] h-[300px] bg-gradient-to-tl from-slate-700 to-slate-900 rounded-full shadow'>
      <div className='relative flex items-center justify-center w-full h-full rounded-full bg-slate-900'>
        ...
        <div className='mb-[16px] text-[70px] select-none'>{getFormatedTime(msLeft)}</div>
